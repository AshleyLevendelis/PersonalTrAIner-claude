...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: true,
    rollupOptions: { input: [path.resolve(__dirname, 'tour-harness.html'), path.resolve(__dirname, 'real.html'), path.resolve(__dirname, 'chat.html'), path.resolve(__dirname, 'profile.html')] },
  },
})
