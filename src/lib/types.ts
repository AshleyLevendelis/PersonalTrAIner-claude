...
export interface ChatReceiptView {
  kind: 'log_workout' | 'propose_exercise_swap' | 'propose_meal_swap' | 'propose_injury_adaptation' | 'propose_equipment_adaptation' | 'memory_fact_saved' | 'memory_goal_saved' | 'memory_context_fact_saved' | 'grocery_item_added' | 'water_logged'
  title: string
