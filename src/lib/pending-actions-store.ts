...
export async function createPendingAction(input: CreatePendingActionInput): Promise<PendingActionRow> {
  ...
  const kindsRequiringPreImage = ['propose_exercise_swap', 'propose_exercise_add', 'propose_exercise_remove', 'propose_exercise_reorder', 'propose_injury_adaptation', 'propose_equipment_adaptation', 'propose_volume_change', 'propose_session_shorten', 'propose_session_length', 'propose_schedule_change', 'propose_style_change', 'propose_goal_change', 'propose_concurrent_activity']
