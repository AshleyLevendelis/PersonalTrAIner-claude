...
export async function createPendingAction(input: CreatePendingActionInput): Promise<PendingActionRow> {
  ...
  const kindsRequiringPreImage = ['propose_exercise_swap', 'propose_injury_adaptation', 'propose_equipment_adaptation', 'propose_volume_change', 'propose_schedule_change', 'propose_style_change', 'propose_concurrent_activity']
