...
// ---------------------------------------------------------------------------
// RE-EXPORTED, so nothing that already imports from here has to move.
//
// The split is about what each half DRAGS IN, not about who calls what:
// everything below is pure over a Tradeoff and needs neither the exercise
// catalogue nor the scorer, which is why the Nutrition screen can reach it
// without pulling 24 kB of exercise data into the first load. See
