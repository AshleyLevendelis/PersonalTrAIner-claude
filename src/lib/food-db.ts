...
export const FOOD_DB: FoodEntry[] = [
  ...
  f('seitan', [], { kcal: 370, protein: 75, carbs: 14, fat: 1.9 }, 'protein', { contains_gluten: true }),
  ...
  f('white rice cooked', ['white rice', 'cooked rice', 'boiled rice', 'jasmine rice'], { kcal: 130, protein: 2.7, carbs: 28, fat: 0.3 }, 'carb', { is_high_carb: true }),
  f('brown rice cooked', ['brown rice', 'cooked brown rice'], { kcal: 123, protein: 2.7, carbs: 25, fat: 1 }, 'carb', { is_high_carb: true }),
  f('basmati rice cooked', ['basmati rice', 'cooked basmati'], { kcal: 121, protein: 2.9, carbs: 25, fat: 0.4 }, 'carb', { is_high_carb: true }),
  f('pasta cooked', ['pasta', 'penne', 'fusilli', 'spaghetti', 'cooked pasta'], { kcal: 158, protein: 5.8, carbs: 31, fat: 0.9 }, 'carb', { contains_gluten: true, is_high_carb: true }),
  ...
  f('couscous cooked', ['couscous'], { kcal: 112, protein: 3.8, carbs: 23, fat: 0.2 }, 'carb', { contains_gluten: true, is_high_carb: true }),
  f('quinoa cooked', ['quinoa'], { kcal: 120, protein: 4.4, carbs: 21, fat: 1.9 }, 'carb', { is_high_carb: true }),
  ...
  f('bulgur wheat cooked', ['bulgur wheat', 'bulgur'], { kcal: 83, protein: 3.1, carbs: 18.6, fat: 0.2 }, 'carb', { contains_gluten: true, is_high_carb: true }),
  f('polenta cooked', ['polenta'], { kcal: 85, protein: 2, carbs: 18, fat: 0.5 }, 'carb', { is_high_carb: true }),
  f('breadcrumbs', ['panko breadcrumbs'], { kcal: 395, protein: 13, carbs: 72, fat: 5.3 }, 'carb', { contains_gluten: true, is_high_carb: true }),
  ...
  f('sweetcorn', ['corn', 'corn on the cob'], { kcal: 96, protein: 3.4, carbs: 21, fat: 1.5 }, 'veg', { is_high_carb: true }),
  ...
  f('seitan strips', ['vegan chicken', 'meat free chicken pieces'], { kcal: 370, protein: 75, carbs: 14, fat: 1.9 }, 'protein', { contains_gluten: true }),
  ...
  f('granola', [], { kcal: 471, protein: 10, carbs: 64, fat: 20 }, 'carb', { is_high_carb: true, contains_nuts: false }),
  f('muesli', [], { kcal: 362, protein: 9.7, carbs: 66, fat: 6 }, 'carb', { is_high_carb: true }),
  f('cornflakes', ['corn flakes'], { kcal: 357, protein: 7.5, carbs: 84, fat: 0.9 }, 'carb', { is_high_carb: true }),
  f('weetabix', ['bran cereal'], { kcal: 338, protein: 11, carbs: 69, fat: 2.5 }, 'carb', { contains_gluten: true, is_high_carb: true }),
  ...
  f('millet cooked', ['millet'], { kcal: 119, protein: 3.5, carbs: 23.7, fat: 1 }, 'carb', { is_high_carb: true }),
  f('buckwheat cooked', ['buckwheat', 'soba noodles'], { kcal: 92, protein: 3.4, carbs: 19.9, fat: 0.6 }, 'carb', { is_high_carb: true }),
