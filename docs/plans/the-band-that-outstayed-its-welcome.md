...
**Measured, the flag is mostly RIGHT.** Of 15 flagged entry/tier combinations,
**11 have genuinely better peers that carry real external load**:
...
**4 of the 15** are flagged only because of a bodyweight-on-apparatus peer:
